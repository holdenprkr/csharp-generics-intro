        ...
        static void Main(string[] args)
        {
            ...
            if (userInput == "1")
            {
                ...
                while (true)
                {
                    ...
                    Console.WriteLine("");
                    foreach (var movie in moviePager.GetPage())
                    {
                        Console.WriteLine($"{movie.Title} -- {movie.Genre}");
                    }
                    Console.WriteLine("");

                    Console.WriteLine("Use your arrow keys to scroll through pages or press enter to exit");
                    var keyPress = Console.ReadKey();
                    if (keyPress.Key == ConsoleKey.RightArrow)
                    {
                        if (pageNumber == Math.Ceiling((double) allMovies.Count / 3) - 1)
                        {
                            pageNumber = 0;
                        }
                        else if (pageNumber < Math.Ceiling((double) allMovies.Count / 3) - 1)
                        {
                            pageNumber += 1;
                        }
                    }
                    else if (keyPress.Key == ConsoleKey.LeftArrow)
                    {
                        if (pageNumber == 0)
                        {
                            pageNumber = Convert.ToInt32(Math.Ceiling((double) allMovies.Count / 3) - 1);
                        }
            ...
            else if (userInput == "2")
            {
                ...
                while (true)
                {
                    ...
                    if (keyPress.Key == ConsoleKey.RightArrow)
                    {
                        if (pageNumber == Math.Ceiling((double) allBooks.Count / 3) - 1)
                        {
                            pageNumber = 0;
                        }
                        else if (pageNumber < Math.Ceiling((double) allBooks.Count / 3) - 1)
                        {
                            pageNumber += 1;
                        }
                    }
                    else if (keyPress.Key == ConsoleKey.LeftArrow)
                    {
                        if (pageNumber == 0)
                        {
                            pageNumber = Convert.ToInt32(Math.Ceiling((double) allBooks.Count / 3) - 1);
                        }
                        else if (pageNumber > 0)
                        {
                            pageNumber -= 1;
